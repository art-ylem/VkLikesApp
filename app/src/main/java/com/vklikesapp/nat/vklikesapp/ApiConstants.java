...
public class ApiConstants {
    public static final String[] DEFAULT_LOGIN_SCOPE = {VKScope.WALL,
            VKScope.PHOTOS, VKScope.GROUPS, VKScope.FRIENDS};
    public static final Double DEFAULT_VERSION = 5.12;
